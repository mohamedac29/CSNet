...
def parse_args():
    parser = argparse.ArgumentParser(description='Train CSNet Segmentation Network')

    parser.add_argument('--cfg',
                        help='experiment configure file name',
                        default="experiments/camvid/CSNet_small_camvid_trainval.yaml",
                        type=str)
